    ...
    <div class="wrapper theme-2-active pimary-color-pink">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" style="background: #27ae60; color: white !important;" >
          ...
          <li class="dropdown alert-drp">
						<a href="#" class="dropdown-toggle" style="color: white !important;" >##</a>
          </li>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<div class="user-profile text-center">
							<img src="" alt="##" class="user-auth-img img-circle"/>
							<div class="dropdown mt-5">
							<a href="#" class="dropdown-toggle pr-0 bg-transparent" data-toggle="dropdown">## <span class="caret"></span></a>
              <ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                <li>
  								<a href=""><i class="zmdi zmdi-account"></i><span>Profil</span></a>
  							</li>
